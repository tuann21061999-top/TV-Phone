...
import { Download, Wallet, ShoppingBag, Users, LineChart as ChartIcon, TrendingUp, ShieldCheck } from 'lucide-react';
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        const res = await axios.get("http://localhost:5000/api/orders/admin/stats/dashboard", {
